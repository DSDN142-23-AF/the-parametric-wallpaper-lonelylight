...
function my_symbol() { // do not rename this function. Treat this similarly to a Draw function
  ...
  generate_color(0,0,r_data,g_data,b_data);
}
...
function generate_color(x,y,r,g,b){
  if(gradient_counter<10&&x<200&&y<200){
    ...
    generate_color(x+1,y,r_data,g_data,b_data);
    //generate_color(x,y+1,r_data,g_data,b_data);
    gradient_counter++;
  }else if(x<200&&y<200){
    gradient_counter=0;
